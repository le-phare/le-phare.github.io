...
nav_order: 1
parent: Versions
permalink: docs/versions/2024.10.html
...
<input type="checkbox"/> Le script [check_2024.10.php](../versions_tests_scripts/check_2024.10.php) est à disposition pour check une bonne partie des prérequis.
...
- <input type="checkbox"/> PostgreSQL 16
