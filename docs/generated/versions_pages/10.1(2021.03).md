...
<input type="checkbox"/> Le script [check_10.1(2021.03).php](../versions_tests_scripts/check_10.1(2021.03).php) est à disposition pour check une bonne partie des prérequis.
