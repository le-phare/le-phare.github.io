...
<input type="checkbox"/> Le script [check_10.0(2019.10).php](../versions_tests_scripts/check_10.0(2019.10).php) est à disposition pour check une bonne partie des prérequis.
