...
nav_order: 6
parent: Versions
permalink: docs/versions/10.1.html
...
<input type="checkbox"/> Le script [check_10.1.php](../versions_tests_scripts/check_10.1.php) est à disposition pour check une bonne partie des prérequis.
